<?php
    ...
    if (isset($_POST['boutonAjoutUtilisateur'])) {        
        ...
        $controlleurAuthentification->ajouter();
    }
?>
<dialog id="dialog_ajout_membre"> 
...
<button onclick="document.getElementById('dialog_ajout_membre').showModal();">Inscription</button>
